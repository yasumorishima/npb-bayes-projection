// Foreign pitcher NPB first-year ERA prediction — v2
//
// Same 7 improvements as hitter model, plus FIP feature.
...
model {
  ...
  beta_age ~ normal(0.05, 0.15);     // older pitchers slightly worse ERA
  beta_reliever ~ normal(-0.3, 0.3); // relievers tend to have lower ERA
  beta_second_year ~ normal(-0.1, 0.2);  // 2nd year adaptation
